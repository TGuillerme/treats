...
trees and traits.}
\author{Anonymous\(^1\)}% \author{Thomas Guillerme\(^1\)}
\date{2023-11-23}

\begin{document}
\maketitle

\(^1\) Anonymous % \(^1\) School of Biosciences, University of Sheffield, Sheffield, S10 2TN, United Kingdom.
\href{mailto:anonymous}{\nolinkurl{anonymous}}% \href{mailto:guillert@tcd.ie}{\nolinkurl{guillert@tcd.ie}}
...
\begin{figure}
\centering
\includegraphics{prepdata-1.pdf}
...
\begin{figure}
\centering
\includegraphics{simtreetraits-1.pdf}
...
\begin{figure}
\centering
\includegraphics{simtreetraitsevents-1.pdf}
...
\begin{figure}
\centering
\includegraphics{simdisparity-1.pdf}
