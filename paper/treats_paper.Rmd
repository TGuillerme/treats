...
Using 30 time units here allows to simulate number of tips in a similar order of magnitude as the ones in the observed data.
...
## Random extinction
plot(drop.singles(sim_rand_extinction[[31]]), main = "Random extinction")
abline(v = 15, col = "red")
abline(h = 0, col = "grey")
legend("topleft", pch = NULL, legend = "A", bty = "n", cex = 2)

## Selective extinction
plot(drop.singles(sim_trait_extinction[[41]]), main = "Positive extinction")
abline(v = 15, col = "red")
abline(h = 0, col = "grey")
legend("topleft", pch = NULL, legend = "B", bty = "n", cex = 2)
```
...
random_extinction_disparity <- rescale.dispRity(random_extinction_disparity)
selective_extinction_disparity <- rescale.dispRity(selective_extinction_disparity)
observed_disparity <- unlist(get.disparity(rescale.dispRity(observed_disparity)))

## Plotting the results with the observed disparity
par(mfrow = c(1,2))
plot(random_extinction_disparity, main = "Random extinction", ylab = "Scaled sum of variances")
abline(v = 3, col = "red")
lines(x = 1:7, y = observed_disparity, lty = 2, lwd = 2)
plot(selective_extinction_disparity, main = "Selective extinction", ylab = "")
abline(v = 3, col = "red")
lines(x = 1:7, y = observed_disparity, lty = 2, lwd = 2)
```
