...
multivariate stuff @adams2019multivarPCM
...
<!-- Integrating with dispRity -->
<!-- Lineage specific simulations. -->
<!-- Abiotic events -->
<!-- Time depend simulations -->

# Conclusion
The `treats` is modular and nice to use.

Extended manual following recommendations from @cooper2016dark
