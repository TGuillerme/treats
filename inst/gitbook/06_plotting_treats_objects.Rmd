...
If you like the plotting style of `treats` trees and data, you can always use the `make.traits` function to plot a tree and some traits as a `"treats"` object.

### Discrete plots

### Continuous plots (with [mapping](#map.traits))