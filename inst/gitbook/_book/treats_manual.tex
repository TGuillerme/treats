...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#\# Converting the data to be passed to dispRity functions}
\NormalTok{dispRity\_data \textless{}{-}}\StringTok{ }\KeywordTok{dispRitreats}\NormalTok{(sim\_data)}

\CommentTok{\#\# Creating the time series (by default dispRitreats scales the trees to be 1 unit of times old)}
\NormalTok{time\_series \textless{}{-}}\StringTok{ }\KeywordTok{chrono.subsets}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ dispRity\_data}\OperatorTok{$}\NormalTok{data,}
                              \DataTypeTok{tree =}\NormalTok{ dispRity\_data}\OperatorTok{$}\NormalTok{tree,}
                              \DataTypeTok{time =} \KeywordTok{seq}\NormalTok{(}\DataTypeTok{from =} \FloatTok{0.9}\NormalTok{, }\DataTypeTok{to =} \DecValTok{0}\NormalTok{, }\DataTypeTok{by =} \FloatTok{{-}0.1}\NormalTok{),}
                              \DataTypeTok{method =} \StringTok{"continuous"}\NormalTok{, }\DataTypeTok{model =} \StringTok{"proximity"}\NormalTok{)}

\CommentTok{\#\# Calculating the disparity from the simulated data}
\NormalTok{simulated\_disparity \textless{}{-}}\StringTok{ }\KeywordTok{dispRity}\NormalTok{(time\_series, }\DataTypeTok{metric =} \KeywordTok{c}\NormalTok{(sum, variances),}
...
\begin{Highlighting}[]
\CommentTok{\#\# Converting the data to be passed to dispRity functions}
\NormalTok{rand\_ext\_data \textless{}{-}}\StringTok{ }\KeywordTok{dispRitreats}\NormalTok{(sim\_rand\_extinction)}
\NormalTok{trait\_ext\_data \textless{}{-}}\StringTok{ }\KeywordTok{dispRitreats}\NormalTok{(sim\_trait\_extinction)}

\CommentTok{\#\# Creating the time series}
\NormalTok{rand\_ext\_time\_series \textless{}{-}}\StringTok{ }\KeywordTok{chrono.subsets}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ rand\_ext\_data}\OperatorTok{$}\NormalTok{data,}
                                       \DataTypeTok{tree =}\NormalTok{ rand\_ext\_data}\OperatorTok{$}\NormalTok{tree,}
                                       \DataTypeTok{time =} \KeywordTok{seq}\NormalTok{(}\DataTypeTok{from =} \FloatTok{0.9}\NormalTok{, }\DataTypeTok{to =} \DecValTok{0}\NormalTok{, }\DataTypeTok{by =} \FloatTok{{-}0.1}\NormalTok{),}
                                       \DataTypeTok{method =} \StringTok{"continuous"}\NormalTok{, }\DataTypeTok{model =} \StringTok{"proximity"}\NormalTok{)}
\NormalTok{trait\_ext\_time\_series \textless{}{-}}\StringTok{ }\KeywordTok{chrono.subsets}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ trait\_ext\_data}\OperatorTok{$}\NormalTok{data,}
                                        \DataTypeTok{tree =}\NormalTok{ trait\_ext\_data}\OperatorTok{$}\NormalTok{tree,}
                                        \DataTypeTok{time =} \KeywordTok{seq}\NormalTok{(}\DataTypeTok{from =} \FloatTok{0.9}\NormalTok{, }\DataTypeTok{to =} \DecValTok{0}\NormalTok{, }\DataTypeTok{by =} \FloatTok{{-}0.1}\NormalTok{),}
                                        \DataTypeTok{method =} \StringTok{"continuous"}\NormalTok{, }\DataTypeTok{model =} \StringTok{"proximity"}\NormalTok{)}


\CommentTok{\#\# Calculating the disparity from the simulated data}
\NormalTok{sim\_rand\_ext\_disp \textless{}{-}}\StringTok{ }\KeywordTok{dispRity}\NormalTok{(rand\_ext\_time\_series, }\DataTypeTok{metric =} \KeywordTok{c}\NormalTok{(sum, variances),}
                              \DataTypeTok{verbose =} \OtherTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics[width=6.5in]{../../../../../../tmp/RtmpwcuuU8/file55f335659f38}
...
\includegraphics[width=6.5in]{../../../../../../tmp/RtmpwcuuU8/file55f34d5ddce7}
...
\includegraphics[width=6.5in]{../../../../../../tmp/RtmpwcuuU8/file55f3254da0ed}
