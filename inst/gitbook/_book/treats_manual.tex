...
\hypersetup{
  ...
  pdfauthor={Thomas Guillerme (t.guillerme@sheffield.ac.uk)},
  hidelinks,
...
\includegraphics{treats_manual_files/figure-latex/unnamed-chunk-63-1.pdf}
...
\includegraphics{treats_manual_files/figure-latex/unnamed-chunk-64-1.pdf}
...
\includegraphics{treats_manual_files/figure-latex/unnamed-chunk-65-1.pdf}
...
\includegraphics{treats_manual_files/figure-latex/unnamed-chunk-66-1.pdf}
...
\includegraphics{treats_manual_files/figure-latex/unnamed-chunk-67-1.pdf}
...
\includegraphics{treats_manual_files/figure-latex/unnamed-chunk-81-1.pdf}
...
\includegraphics{treats_manual_files/figure-latex/unnamed-chunk-83-1.pdf}
...
\includegraphics{treats_manual_files/figure-latex/unnamed-chunk-84-1.pdf}
...
\includegraphics{treats_manual_files/figure-latex/unnamed-chunk-87-1.pdf}
...
\includegraphics{treats_manual_files/figure-latex/unnamed-chunk-95-1.pdf}
...
\includegraphics{treats_manual_files/figure-latex/unnamed-chunk-96-1.pdf}
...
\includegraphics{treats_manual_files/figure-latex/unnamed-chunk-97-1.pdf}
...
\includegraphics{treats_manual_files/figure-latex/unnamed-chunk-108-1.pdf}
...
\includegraphics{treats_manual_files/figure-latex/unnamed-chunk-111-1.pdf}
...
\includegraphics{treats_manual_files/figure-latex/unnamed-chunk-112-1.pdf}
...
\includegraphics{treats_manual_files/figure-latex/unnamed-chunk-114-1.pdf}
...
\includegraphics{treats_manual_files/figure-latex/unnamed-chunk-115-1.pdf}
...
\includegraphics[width=6.5in]{../../../../../../tmp/RtmpNKmbbM/file9d7231f94b74}
...
\includegraphics[width=6.5in]{../../../../../../tmp/RtmpNKmbbM/file9d724094c3af}
...
\begin{Highlighting}[]
\KeywordTok{set.seed}\NormalTok{(}\DecValTok{1}\NormalTok{)}
\CommentTok{\#\# Generating some random tree}
\NormalTok{my\_tree \textless{}{-}}\StringTok{ }\KeywordTok{makeNodeLabel}\NormalTok{(}\KeywordTok{rcoal}\NormalTok{(}\DecValTok{20}\NormalTok{))}

\CommentTok{\#\# Generating some random discrete data}
\NormalTok{discrete\_data \textless{}{-}}\StringTok{ }\KeywordTok{sample}\NormalTok{(}\KeywordTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{,}\DecValTok{2}\NormalTok{), }\DecValTok{39}\NormalTok{, }\DataTypeTok{replace =} \OtherTok{TRUE}\NormalTok{)}
\KeywordTok{names}\NormalTok{(discrete\_data) \textless{}{-}}\StringTok{ }\KeywordTok{c}\NormalTok{(my\_tree}\OperatorTok{$}\NormalTok{tip.label, my\_tree}\OperatorTok{$}\NormalTok{node.label)}

\CommentTok{\#\# Creating a treats object with this data}
\NormalTok{discrete\_treats \textless{}{-}}\StringTok{ }\KeywordTok{make.treats}\NormalTok{(}\DataTypeTok{tree =}\NormalTok{ my\_tree, }\DataTypeTok{data =}\NormalTok{ discrete\_data)}

\CommentTok{\#\# Plot the data together}
\KeywordTok{plot}\NormalTok{(discrete\_treats, }\DataTypeTok{legend =} \OtherTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{treats_manual_files/figure-latex/unnamed-chunk-118-1.pdf}

The same goes for continuous data:

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#\# Generating some random continuous data}
\NormalTok{continuous\_data \textless{}{-}}\StringTok{ }\KeywordTok{rnorm}\NormalTok{(}\DecValTok{39}\NormalTok{)}
\KeywordTok{names}\NormalTok{(continuous\_data) \textless{}{-}}\StringTok{ }\KeywordTok{c}\NormalTok{(my\_tree}\OperatorTok{$}\NormalTok{tip.label, my\_tree}\OperatorTok{$}\NormalTok{node.label)}

\CommentTok{\#\# Creating a treats object with this data}
\NormalTok{continuous\_treats \textless{}{-}}\StringTok{ }\KeywordTok{make.treats}\NormalTok{(}\DataTypeTok{tree =}\NormalTok{ my\_tree, }\DataTypeTok{data =}\NormalTok{ continuous\_data)}

\CommentTok{\#\# Plot the data together}
\KeywordTok{plot}\NormalTok{(continuous\_treats)}
\end{Highlighting}
\end{Shaded}

\includegraphics{treats_manual_files/figure-latex/unnamed-chunk-119-1.pdf}
...
\includegraphics{treats_manual_files/figure-latex/unnamed-chunk-127-1.pdf}
...
\includegraphics{treats_manual_files/figure-latex/unnamed-chunk-133-1.pdf}
...
\includegraphics{treats_manual_files/figure-latex/unnamed-chunk-137-1.pdf}
...
\includegraphics{treats_manual_files/figure-latex/unnamed-chunk-141-1.pdf}
...
\includegraphics[width=6.5in]{../../../../../../tmp/RtmpNKmbbM/file9d727fb11a9c}
...
\includegraphics{treats_manual_files/figure-latex/unnamed-chunk-154-1.pdf}
...
\includegraphics{treats_manual_files/figure-latex/unnamed-chunk-158-1.pdf}
