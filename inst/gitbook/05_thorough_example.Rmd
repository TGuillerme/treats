...
Three events then happen during the evolutionary history of this lineage: 
 ...
 2. "Correlation event": after reaching a certain number of taxa an event happens making the "Variables" trait dimensions become correlated.
...
events_list <- make.events(event.name   = "Selection",
                           ...
                           modification = trait.extinction(0, condition = `<`, trait = 2))
```
