...
## A verbose example: mammals disparity through the K-Pg extinction {kpgexample}


Ar Macarface is studying the evolution of mammalian disparity (i.e. diversity of shapes) across the Cretaceous-Palaeogene mass extinction event (K-Pg - 66 million years ago).

They use a dataset from @BeckLee that is a discrete morphological space containing the ordination of the around 400 morphological characters for 50 species and estimated for their 49 descendants into an ordinated shapespace of 99 elements and 97 dimensions.
...
Looking at this curve, Ar wants to know whether disparity increased as a response to the K-Pg mass extinction or not.
...
## Setting the stopping rule (stop when reaching a total of 50 taxa)
...
## Creating an extrinction that removes species with negative trait values
